    ...
    buttonNextPage(type) {
        ...
        if(type === 'L') {
            if(this.state.pptIndex !== 0) {
                return(<img className="button-left" onClick={this.nextPPt.bind(this,type)} src="./assetsFund/image/course/pptButtonLeft.png"/>
                )
            }
        } else {
            if(this.state.pptIndex !== this.state.content.pptUrl.length - 1) {
                return(<img className="button-right" onClick={this.nextPPt.bind(this,type)} src="./assetsFund/image/course/pptButtonRight.png"/>
                )
            }
        }
