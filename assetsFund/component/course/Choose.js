...
const ChooseBar = React.createClass({
    ...
    //         if(question.trueindex[0] === index) {
    //             this.state.nowClick = index
    //             return <img className= "choose-options-img" src={'./assetsFund/image/course/indRight.png'}></img>
    //         } else {
    //             return null;
    //         }
    //     } else if(this.state.nowClick === index){
    ...
    //             return <img className= "choose-options-img" src={'./assetsFund/image/course/indRight.png'}></img>
    //         } else if(this.state.results[index] === 0){
    //             return <img className= "choose-options-img" src={'./assetsFund/image/course/indWrong.png'}></img>
    //         }
    //     }
    // },
